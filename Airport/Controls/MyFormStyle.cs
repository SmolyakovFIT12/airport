...
namespace Airport
{
    public partial class MyFormStyle : Component
    {
        #region -- Свойства --
        ...
        [Description("Вверх для maximize")]
        public bool AllowDropForMaximize { get; set; } = true;

        #endregion
        #region -- Поля --

        private Dictionary<fStyle, MyStyle> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private MyStyle CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        Point point1BtnMin, point2BtnMin;
        Rectangle rectMaxButtonIcon, rectMaxButtonIconSecond;
        ...
        public MyFormStyle(IContainer container)
        {
            DefineStyles();
        ...
        {
            StylesDictionary = new Dictionary<fStyle, MyStyle>();
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                MyStyle NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void SaveUserStyleConfig()
        {
            if (StylesDictionary.ContainsKey(fStyle.UserStyle) && StyleUsed == false)
            {
                ...
                MyStyle UserStyle = StylesDictionary[fStyle.UserStyle];
        ...
        private void Form_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (Cursor.Position.Y == Screen.FromHandle(Form.Handle).WorkingArea.Y
                && Form.WindowState == FormWindowState.Normal && AllowDropForMaximize)
            {
        ...
        private void DrawStyle(Graphics graph)
        {
            ...
            if (Form.MaximizeBox == true)
            {
                ...
                rectMaxButtonIcon = new Rectangle(
                ...
                rectMaxButtonIconSecond = rectMaxButtonIcon;
            }
